#!/usr/bin/env python3
"""
Test script for the lightweight Vercel FastAPI deployment
"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if result.get('basic_stats'):
                print(f"Basic stats keys: {list(result['basic_stats'].keys())}")
        else:
...
def main():
    """Run all tests"""
    print("Starting Lightweight Vercel API tests...")
    print("=" * 50)
    ...
    if passed == total:
        print("✅ All tests passed! The lightweight API is ready for Vercel deployment.")
    else:
